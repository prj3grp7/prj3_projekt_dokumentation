...
<<<<<<< HEAD
#define BS_UDB_0_1_0_CONFIG_VAL ((const uint8 CYFAR *)0x480003D4u)

/* IOPINS0_7 Address: CYREG_PRT12_DR Size (bytes): 10 */
#define BS_IOPINS0_7_VAL ((const uint8 CYFAR *)0x48000454u)
...
=======
#define BS_UDB_0_1_0_CONFIG_VAL ((const uint8 CYFAR *)0x480003D8u)
...
/* CYDEV_CLKDIST_ACFG0_CFG0 Address: CYREG_CLKDIST_ACFG0_CFG0 Size (bytes): 4 */
#define BS_CYDEV_CLKDIST_ACFG0_CFG0_VAL ((const uint8 CYFAR *)0x4800046Cu)
>>>>>>> fix
...
<<<<<<< HEAD
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG2_CFG0), 0x016Bu);
=======
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG2_CFG0), 0x176Fu);
>>>>>>> fix
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)CYREG_PRT1_AMUX, 0x8040u);
...
{
	if (channel) {} /* Mux has no inputs, thus no switches to modify */
}
